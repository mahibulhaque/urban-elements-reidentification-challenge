...
def read_csv_gt(csv_path):
    """Read Ground Truth (test_classes.csv or query_classes.csv)"""
...
parser.add_argument("--path", default="./data/", help="Folder containing query_classes.csv and test_classes.csv")
args = parser.parse_args()

# 1. Load Data
# Gallery: IDs needed in a list ordered by image index
gallery_dict, gallery_names = read_csv_gt(os.path.join(args.path, 'test_classes.csv'))
...
query_dict, query_names = read_csv_gt(os.path.join(args.path, 'query_classes.csv'))
