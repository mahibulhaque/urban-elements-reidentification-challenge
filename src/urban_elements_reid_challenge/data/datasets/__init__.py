from urban_elements_reid_challenge.utils.registry import Registry
...
from .UrbanElementsReID_val import UrbanElementsReID_val
from .UrbanElementsReID_trafficsign import (
    UrbanElementsReID_trafficsign,
    UrbanElementsReID_val_trafficsign,
)
from .UrbanElementsReID_with_MNN import UrbanElementsReID_with_MNN
from .UrbanElementsReID_with_val import UrbanElementsReID_with_val
from .SplitV2ReID import SplitV2ReID
