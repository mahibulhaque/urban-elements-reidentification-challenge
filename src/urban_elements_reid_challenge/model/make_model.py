...
from .backbones.vit_pytorch import deit_tiny_patch16_224_TransReID, part_attention_deit_small, part_attention_deit_tiny, part_attention_vit_base, part_attention_vit_base_p32, part_attention_vit_huge, part_attention_vit_large, part_attention_vit_small, vit_base_patch32_224_TransReID, vit_large_patch16_224_TransReID
import torch
...
imagenet_path_name = {
    ...
    # MAE self-supervised pretrain (transfers better than supervised 21k for ReID).
    # If you want the IN-21k variant, use 'vit_huge_patch14_224_in21k.pth'.
    'vit_huge_patch14_224_TransReID': 'vit_huge_patch14_224_mae.pth',
}
...
class build_vit(nn.Module):
    def __init__(self, num_classes, cfg, factory):
        ...
        if cfg.MODEL.TRANSFORMER_TYPE == 'deit_small_patch16_224_TransReID':
            ...
            self.in_planes = 1024
        elif cfg.MODEL.TRANSFORMER_TYPE == 'vit_huge_patch14_224_TransReID':
            self.in_planes = 1280
...
__factory_LAT_type = {
    ...
    'vit_huge_patch14_224_TransReID': part_attention_vit_huge,
}
